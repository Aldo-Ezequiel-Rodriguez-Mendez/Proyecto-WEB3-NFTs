...
async function createJsonInfo() {
    const metadata = {
        image: "https://gateway.pinata.cloud/ipfs/Qmezm4CXp5LxFdGJdjENuVSgvzcKDX4QAZ29wdmGZYBXDZ",
        name: "Equipo 11",
        description: "Foto durmiendo en clase XD",
        attributes: [
...
async function mintNFT() {
    ...
    const transaction = {
        ...
        data: etherInterface.encodeFunctionData("mintNFT",
            [PUBLIC_KEY, "https://gateway.pinata.cloud/ipfs/QmSh1wz7Z34vN55urhbttZTcfSLLs3iJ6wSFaLio2z6y5W"])
    }
